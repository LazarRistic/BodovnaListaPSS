 ...
 */
class ClubViewModel(id: String, application: Application) : AndroidViewModel(application) {
    private val clubsRepository = ClubsRepository(application, ClubsApiService.clubsApi)
